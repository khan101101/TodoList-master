...
import Khan101.datamodel.TodoData;
    ...
    public void initialize() {
      ...
      //          LocalDate.of(2016, Month.APRIL, 25));
       ...
       // todoItems.add(item5);
        ...
        //Every time something is changed in the todoItems, this event handler is gonna fire
        ...
        todoListView.getItems().setAll(TodoData.getInstance().getTodoItems());      //populate the todoList
